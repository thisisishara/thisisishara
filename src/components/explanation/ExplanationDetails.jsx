...
export default class ExplanationDetails extends Component {
  ...
  render() {
    return (
      <Box className="mb-5">
        {/* <div className="alert app-alert mb-4" role="alert"> */}
        <Box sx={{ width: '100%' }}>
          <Collapse in={this.state.setOpen}>
            <Alert
              ...
              Learn how to interpret Dual Feature Importance Scores <a href={`${configs.kolloqeDocsXAI}`} target={'_blank'} rel={'noreferrer'}>here</a>
            </Alert>
          </Collapse>
        </Box>
