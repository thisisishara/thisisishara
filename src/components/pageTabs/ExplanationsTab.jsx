...
export default class ExplanationsTab extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      selectedLanguage: localStorage.getItem(`${localStorageKeys.kolloqeSelectedLang}`) || "en",
                  ...
                  <Box className="input-group input-group-dark">
                    <Box className="d-flex mb-3 p-0 w-100">
                      ...
                      <KeyboardInput
                        ...
                        defaultLanguage={this.props.appConfigs.custom_configs.keyboard_enabled ? (localStorage.getItem(`${localStorageKeys.kolloqeSelectedLang}`) || "si") : "en"}
