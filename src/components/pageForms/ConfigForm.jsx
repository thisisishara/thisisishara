          ...
          <Box className="row justify-content-center mb-4">
            ...
            <Box className="col-md-7 col-lg-5">
              <Box className="mb-4 mx-0 p-0 w-100" id="modelModeRadioGroup">
                <label
                  className={`list-group-item d-flex gap-2 rubik mx-0 ${this.state.configs.model_mode === "local"
                    ? " container-bg-green"
                    : "container-bg-select"
                    }`}
                  id="modelModeRestLabel" >
                  <input
                    className={`form-check-input flex-shrink-0 ${this.state.configs.model_mode === "local" &&
                      "material-green"
                      }`}
                    checked={
                      this.state.configs.model_mode === "local" ? true : false
                    }
                    type="radio"
                    name="modelMode"
                    id="modelModeLocal"
                ...
                <label
                  className={`list-group-item d-flex gap-2 rubik mx-0 ${this.state.configs.model_mode === "rest"
                    ? " container-bg-green"
                    : "container-bg-select"
                    }`}
                  id="modelModeRestLabel" >
                  <input
                    className={`form-check-input flex-shrink-0 ${this.state.configs.model_mode === "rest" &&
                      "material-green"
                      }`}
                    checked={
                      this.state.configs.model_mode === "rest" ? true : false
                    }
                    type="radio"
                    name="modelMode"
                    id="modelModeRest"
