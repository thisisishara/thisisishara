      ...
      <>
        <Box className="row row-cols-1 row-cols-lg-3" justifyContent='space-between' sx={{ marginY: 2 }}>
          <DashboardBannerTile
            ...
            count={this.props.stats === undefined ? "" : this.props.stats.models}
            title={this.props.stats === undefined ? " Models" : (this.props.stats.models === 1 ? " Model" : " Models")}
          ...
          <DashboardBannerTile
            ...
            count=""
            title=" Docs"
            content="Refer the official Kolloqui docs to get familiar
