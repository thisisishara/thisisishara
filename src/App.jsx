...
import './App.css';
import { configs, kolloqe_ascii } from './configs';
...
import Dime from './pages/dime/Dime';
...
export default class App extends React.Component {
  constructor(props) {
    ...
    console.log(`%c ${kolloqe_ascii}`, 'background: none; color: #bada55;');
  ...
  fetchConfigs() {
    ...
    axios.get(configs.configEndpoint, payload)
                ...
                <Routes>
                  <Route
                    index element={<Dashboard
                      ...
                      webchatConfigs={this.props.webchatConfigs} />} /> 
                  <Route
                  path="annotations"
                  element={<Annotations
                    appConfigs={this.state.appConfigs}
